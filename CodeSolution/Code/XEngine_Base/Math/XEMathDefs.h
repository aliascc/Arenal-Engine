...
#ifndef _XE_MATH_DEFS_H
#define _XE_MATH_DEFS_H
...
*   Defines   *
***************/
#define XE_DEFAULT_ROTATION_ORDER	RotationOrder::EulerZYX
...
namespace XEMathHelpers
{
	...
	************************/
	...
	inline glm::mat4 CreateRotation(const glm::vec3& rotation, RotationOrder rotationOrder = XE_DEFAULT_ROTATION_ORDER)
	{
	...
	inline glm::mat4 CreateTransform(const glm::vec3& translation, const glm::vec3& rotation, const glm::vec3& scale, RotationOrder rotationOrder = XE_DEFAULT_ROTATION_ORDER)
	{
	...
	inline glm::quat CreateQuatRotation(const glm::vec3& angles, RotationOrder rotationOrder = XE_DEFAULT_ROTATION_ORDER)
	{
	...
	inline glm::quat CreateQuatRotation(float pitch, float yaw, float roll, RotationOrder rotationOrder = XE_DEFAULT_ROTATION_ORDER)
	{
	...
	inline glm::vec3 CalculateDirectionFromAngles(const glm::vec3& angles, const glm::vec3& forwardVector = Vec3fFwrZP, RotationOrder rotationOrder = XE_DEFAULT_ROTATION_ORDER)
	{
	...
	inline glm::mat4 GetRotationMatrixFromTransformationMatrix(const glm::mat4& transformationMatrix)
	{
		...
		glm::mat4 rotationMatrix = __XE_GetRotationMatrixFromTransformationMatrix(transformationMatrix, scaleVector);
	...
	inline glm::vec3 GetEulerAnglesFromQuaternionRotation(const glm::quat& quatRot, RotationOrder rotationOrder = XE_DEFAULT_ROTATION_ORDER)
	{
		//p0 = quatRot.w
		//p1 = quatRot.x
		//p2 = quatRot.y
	...
	inline void GetTransformationFromRelativeToParent(const glm::mat4& parentTransform, const glm::quat& parentQuaternionRot, const glm::mat4& parentScaleTransform, const glm::quat& currentWorldQuaternionRot, const glm::mat4& currentWorldTransform, const glm::mat4& currentWorldScaleTransform, glm::vec3& localPosition, glm::vec3& localRotation, glm::vec3& localScale)
	{
		...
		localPosition = XEMathHelpers::GetPositionVectorFromMatrix(newLocalTransform);

		//////////////////////////////////////////////////
		// Get the Scale vector
		localScale = XEMathHelpers::GetScaleVectorFromTransformationMatrix(newLocalScaleTransform);

		//////////////////////////////////////////////////
		// Get the Rotation vector
		localRotation = glm::degrees(XEMathHelpers::GetEulerAnglesFromQuaternionRotation(newLocalQuatRotation));
	}
