...
#define XE_PROJ_RAW_FILES_DIR_LOC			(XE_PROJ_DATA_DIR L"/" XE_PROJ_RAW_FILES_DIR)

#define XE_PROJ_EFFECTS_DIR_LOC				(XE_PROJ_DATA_DIR L"/" XE_PROJ_EFFECTS_DIR)
...
#define XE_PROJ_LOCALIZATION_DIR_LOC		(XE_PROJ_DATA_DIR L"/" XE_PROJ_LOCALIZATION_DIR)

#define XE_PROJ_LOG_DIR_LOC					(XE_PROJ_DATA_DIR L"/" XE_PROJ_LOG_DIR)
...
#define XE_SHADER_SYS_INC_PATH				(XE_ENGINE_BIN_TO_DATA_PATH_PREFIX XE_PROJ_DATA_DIR L"/" XE_PROJ_EFFECTS_DIR)
