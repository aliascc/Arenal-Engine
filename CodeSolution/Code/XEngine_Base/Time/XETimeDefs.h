...
#ifndef _XE_TIME_DEFS_H
#define _XE_TIME_DEFS_H
...
*   Struct Decl   *
*******************/
struct TimerParams sealed : public XEObject
{
	/***********************
	*   Public Variables   *
	************************/
...
struct TimeStamp sealed : public XEObject
{
	/***********************
	*   Public Variables   *
	************************/
...
#pragma region Framework Methods
	...
	/// <returns>XEResult::Ok if parse was successful</returns>
	XEResult GetFromString(const std::wstring& str);
