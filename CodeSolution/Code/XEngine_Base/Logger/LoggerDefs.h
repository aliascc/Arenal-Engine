...
/// </summary>
#define XELOGGER					Logger::GetInstance()
...
/// </summary>
#define XE_LOG_DUPLICATE_TIME		1.0

/// <summary>
/// Define how many seconds the timeout to count
/// logs as duplicates
/// </summary>
#define XE_LOG_DUPLICATE_TIMEOUT	5.0

/// <summary>
/// Sleep Time for Timeout monitor thread in seconds
/// </summary>
#define XE_LOG_TIMEOUT_THREAD_SLEEP	5
...
/// </summary>
struct XELastLog sealed : public XEObject
{
...
/// </summary>
struct XELog sealed : public XEObject
{
...
#pragma region Public Methods
	...
	/// <summary>
	/// Override method ToString, use to convert a XELog to a string
	/// </summary>
	std::wstring ToString() const override;

	/// <summary>
	/// Override equal operator for XELog
	/// </summary>
	XELog& operator=(const XELog &other);
...
/// </summary>
typedef std::list<XELog> LogList;
