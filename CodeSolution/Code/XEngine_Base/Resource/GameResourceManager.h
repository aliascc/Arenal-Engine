...
*   Class Decl   *
******************/
class GameResourceManager sealed : public XEObject
{
...
#pragma region Framework Methods
		...
		XEResult ManageGameResource(GameResource* gameResource, const std::wstring& stringID = L"", bool keepAlive = false);
		...
		/// <returns>XEResult::Ok if successful</returns>
		XEResult UnManageGameResource(uint64_t id);
