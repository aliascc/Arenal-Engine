...
class XBoxGamepad sealed : public AEObject
{
    private:
...
#pragma region Private Variables
        ...
        /// </summary>
        float m_InitWaitTimeRetry = AE_XBOX_GAMEPAD_INIT_WAIT_TIME;

        /// <summary>
        /// Previous State of the Gamepad Buttons
        /// </summary>
        uint8_t m_GamepadPrevState[AE_MAX_XBOX_GP_BUTTONS];

        /// <summary>
        /// Current State of the Gamepad Buttons
        /// </summary>
        uint8_t m_GamepadCurrentState[AE_MAX_XBOX_GP_BUTTONS]; 

        /// <summary>
        /// Current State of the Gamepad Movement Buttons
        /// </summary>
        float m_GamepadMovementCurrentState[AE_MAX_XBOX_GP_MOV_BUTTONS];
...
#pragma region Private Methods
        ...
        /// </summary>
        /// <returns>AEResult::Ok if Gamepad was initialized correctly, AEResult::Fail if it was not.</returns>
        AEResult Initialize();
...
#pragma region Framework Methods
        ...
        bool WasButtonPressed(AEXBoxGamepadButton button) const;
        ...
        bool IsButtonUp(AEXBoxGamepadButton button) const;
        ...
        bool IsButtonDown(AEXBoxGamepadButton button) const;
        ...
        bool IsHoldingButton(AEXBoxGamepadButton button) const;
        ...
        bool HasReleasedButton(AEXBoxGamepadButton button) const;
        ...
        float GetMovement(AEXBoxGamepadMovements movButton) const;
