...
*   Function Defs   *
*********************/
EditorCamera::EditorCamera(const std::string& name, const glm::vec3& position, const glm::vec3& target, const glm::vec3& UP, const glm::ivec2& dimensions, float fov, float znear, float zfar)
...
AEResult EditorCamera::Update(const TimerParams& timerParams)
{
    ...
    AETODO("Remove control from camera from here");
