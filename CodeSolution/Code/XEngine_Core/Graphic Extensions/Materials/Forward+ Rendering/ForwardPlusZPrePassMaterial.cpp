...
#include "Compiled Materials\HLSL\ForwardPlusZPrePass_x64_d.h"
	#else
#include "Compiled Materials\HLSL\ForwardPlusZPrePass_x86_d.h"
	#endif
#else
	#if defined(_WIN64) | defined (WIN64) 
#include "Compiled Materials\HLSL\ForwardPlusZPrePass_x64.h"
	#else
#include "Compiled Materials\HLSL\ForwardPlusZPrePass_x86.h"
	#endif
#endif
...
*   Function Defs   *
*********************/
ForwardPlusZPrePassMaterial::ForwardPlusZPrePassMaterial(GraphicDevice* graphicDevice, GameResourceManager* gameResourceManager, const std::wstring& name)
...
XEResult ForwardPlusZPrePassMaterial::CreateVertexShader()
{
	XEResult ret = XEResult::Ok;

	/////////////////////////////////////////////////////
	//Get Vertex Shader from Game Resources
	m_VertexShader = (VertexShader*)m_GameResourceManager->AcquireGameResourceByStringID(XE_FORWARD_PLUS_Z_PRE_PASS_MAT_VS_NAME, GameResourceType::VertexShader);

	if(m_VertexShader == nullptr)
	{
		m_VertexShader = new VertexShader(m_GraphicDevice, XE_FORWARD_PLUS_Z_PRE_PASS_MAT_VS_NAME);
		...
		ret = m_GameResourceManager->ManageGameResource(m_VertexShader, XE_FORWARD_PLUS_Z_PRE_PASS_MAT_VS_NAME);
		if(ret != XEResult::Ok)
		{
...
XEResult ForwardPlusZPrePassMaterial::CreateVertexShaderConstantBuffer()
{
	XEResult ret = XEResult::Ok;
...
XEResult ForwardPlusZPrePassMaterial::LoadContent()
{
