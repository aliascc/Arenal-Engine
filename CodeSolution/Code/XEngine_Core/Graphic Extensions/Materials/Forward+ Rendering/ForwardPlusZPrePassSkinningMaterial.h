...
#pragma region Constructor & Destructor Methods
		...
		ForwardPlusZPrePassSkinningMaterial(GraphicDevice* graphicDevice, GameResourceManager* gameResourceManager, const std::wstring& name = XE_FORWARD_PLUS_Z_PRE_PASS_MAT_NAME);
