...
XEResult TextureCube::Load()
{
	...
	XEGraphicHelpers::SetDebugObjectName<ID3D11Texture2D>(m_TextureDX, XE_DEBUG_TEX_CUBE_NAME_PREFIX + XE_Base::WideStr2String(m_Name));
	...
	XEGraphicHelpers::SetDebugObjectName<ID3D11ShaderResourceView>(m_ShaderResourceView, XE_DEBUG_TEX_CUBE_SRV_NAME_PREFIX + XE_Base::WideStr2String(m_Name));
...
XEResult TextureCube::CreateFromFile(const std::wstring& textureFile)
{
