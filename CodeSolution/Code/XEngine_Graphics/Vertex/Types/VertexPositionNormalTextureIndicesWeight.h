...
struct VertexPositionNormalTextureIndicesWeight
{
	...
	static const VertexLayout* GetVertexLayout(GraphicDevice* graphicDevice)
	{
		...
		XEResult ret = m_VertexLayout->BuildVertexLayout(graphicDevice, DummyVertexPositionNormalTextureIndicesWeight, sizeof(DummyVertexPositionNormalTextureIndicesWeight), vertexDesc, 5, L"DummyVertexPositionNormalTextureIndicesWeightLayout");
