...
#include "Compiled Materials\HLSL\DummyVertexPositionNormalColor_x64_d.h"		
	#else
#include "Compiled Materials\HLSL\DummyVertexPositionNormalColor_x86_d.h"
	#endif
#else
	#if defined(_WIN64) | defined (WIN64) 
#include "Compiled Materials\HLSL\DummyVertexPositionNormalColor_x64.h"
	#else
#include "Compiled Materials\HLSL\DummyVertexPositionNormalColor_x86.h"
	#endif
#endif
...
struct VertexPositionNormalColor
{
	...
	static const VertexLayout* GetVertexLayout(GraphicDevice* graphicDevice)
	{
		...
		XEResult ret = m_VertexLayout->BuildVertexLayout(graphicDevice, DummyVertexPositionNormalColor, sizeof(DummyVertexPositionNormalColor), vertexDesc, 3, L"VertexPositionNormalColorLayout");
