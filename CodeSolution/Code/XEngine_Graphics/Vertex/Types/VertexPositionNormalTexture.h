...
struct VertexPositionNormalTexture
{
	...
	static const VertexLayout* GetVertexLayout(GraphicDevice* graphicDevice)
	{
		...
		XEResult ret = m_VertexLayout->BuildVertexLayout(graphicDevice, DummyVertexPositionNormalTexture, sizeof(DummyVertexPositionNormalTexture), vertexDesc, 3, L"VertexPositionNormalTextureLayout");
