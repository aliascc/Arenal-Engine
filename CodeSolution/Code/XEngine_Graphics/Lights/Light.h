...
*   Class Decl   *
******************/
class Light abstract : public UniqueXEObjectNamed
{
...
#pragma region Protected Variables
		...
		/// </summary>
		uint32_t m_ShadowTextureIndex = XE_LIGHT_SHADOW_DISABLE_INDEX;
...
#pragma region Constructor & Destructor Methods
		...
		/// Light Constructor
		/// </summary>
		Light(LightType lightType, const std::wstring& name = L"Light", const glm::vec3& position = XEMathHelpers::Vec3fZero, const glm::vec3& direction = XEMathHelpers::Vec3fZero, const Color& color = XEColors::White, float nearAtteniation = 0.0f, float farAttenuation = 0.0f, float intensity = 1.0f, bool enable = true);
...
#pragma region Get Methods
		...
		{
			return m_ShadowEnabled && m_ShadowTextureIndex != XE_LIGHT_SHADOW_DISABLE_INDEX;
		}
