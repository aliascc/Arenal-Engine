...
bool Light::operator==(const LightFX& other)
{
	return	(
				...
				this->m_Direction			== other.m_Direction										&&
				this->m_Intensity			== other.m_Intensity										&&
				this->m_Enabled				== ((other.m_LightFXFlags & XE_LFXF_Enabled) != 0)			&&
				this->m_ShadowEnabled		== ((other.m_LightFXFlags & XE_LFXF_ShadowEnabled) != 0)	&&
				this->m_ShadowTextureIndex	== other.m_ShadowTextureIndex
			);
}
...
void Light::UpdateLighFX(LightFX& lightFX)
{
	...
	lightFX.m_LightFXFlags			|= (this->m_Enabled ? XE_LFXF_Enabled : 0x00);
	lightFX.m_LightFXFlags			|= (this->m_ShadowEnabled ? XE_LFXF_ShadowEnabled : 0x00);
}