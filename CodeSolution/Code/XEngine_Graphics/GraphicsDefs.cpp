...
XEResult GraphicDebugDX::Initialize()
{
...
void GraphicDebugDX::Report()
{
	if(m_D3D11Debug != nullptr)
	{
		OutputDebugString(L"\n\n--------XEngine Calling ReportLiveDeviceObjects--------\n\n\n");
		m_D3D11Debug->ReportLiveDeviceObjects(D3D11_RLDO_DETAIL);
		OutputDebugString(L"\n\n--------XEngine End Call ReportLiveDeviceObjects--------\n\n\n");
	}

	if(m_DXGIDebug != nullptr)
	{		
		OutputDebugString(L"\n\n--------XEngine Calling ReportLiveObjects--------\n\n\n");
		m_DXGIDebug->ReportLiveObjects(DXGI_DEBUG_ALL, DXGI_DEBUG_RLO_ALL);
		OutputDebugString(L"\n\n--------XEngine End Call ReportLiveObjects--------\n\n\n");
	}
}
...
**************************************/
XETODO("CHECK VARIABLES TO REMOVE");
...
XEResult GraphicBlendStates::InitStates(GraphicDevice* graphicDevice)
{
	XEAssert(graphicDevice != nullptr);
	...
	XEGraphicHelpers::SetDebugObjectName<ID3D11BlendState>(m_DefaultState, XE_DEBUG_DEFAULT_BLEND_STATE_NAME);
	...
	XEGraphicHelpers::SetDebugObjectName<ID3D11BlendState>(m_AdditiveState, XE_DEBUG_ADDICTIVE_BLEND_STATE_NAME);
	...
	XEGraphicHelpers::SetDebugObjectName<ID3D11BlendState>(m_AlphaBlendState, XE_DEBUG_ALPHA_BLEND_STATE_NAME);
	...
	XEGraphicHelpers::SetDebugObjectName<ID3D11BlendState>(m_OpaqueState, XE_DEBUG_OPAQUE_BLEND_STATE_NAME);
	...
	XEGraphicHelpers::SetDebugObjectName<ID3D11BlendState>(m_NonPremultipliedState, XE_DEBUG_NON_PREMULTIPLIED_BLEND_STATE_NAME);
...
namespace XEGraphicHelpers
{
	...
	{
		RECT rectWnd;
		glm::ivec2 wndSize = XEMathHelpers::Vec2iZero;
