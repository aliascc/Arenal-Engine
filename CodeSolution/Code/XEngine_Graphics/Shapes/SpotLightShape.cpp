...
XEResult SpotLightShape::BuildLightShape()
{
	///////////////////////////////////////////////////
	//Pre-checks
...
XEResult SpotLightShape::UpdateLightInfo(float nearAttenuation, float farAttenuation, float angle, float fallOfAngle)
{
	if (!m_IsReady)
	{
...
void SpotLightShape::UpdateInnerConeAndLines()
{
	...
	startPoints[0] = startPoints[1] = startPoints[2] = startPoints[3] = XEMathHelpers::Vec3fZero;
