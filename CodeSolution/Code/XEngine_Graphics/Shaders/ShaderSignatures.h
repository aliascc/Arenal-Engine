...
*   Struct   *
**************/
struct ConstantBufferSignature : public XEObject
{
...
struct SimpleBufferSignature : public XEObject
{
	std::wstring m_Name = L"";
...
struct StructuredBufferSignature : public XEObject
{
	std::wstring m_Name = L"";
...
struct TextureInputSignature : public XEObject
{
	std::wstring m_Name = L"";
...
struct TextureArrayInputSignature : public XEObject
{
	std::wstring m_Name = L"";
...
struct SamplerSignature : public XEObject
{
	std::wstring m_Name = L"";
