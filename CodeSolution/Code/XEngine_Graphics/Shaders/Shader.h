...
#pragma region Private Methods
		...
		XEResult ReadShaderByteCode(std::ifstream& fileStream, BYTE** shaderByteCode, uint32_t& shaderByteCodeSize);

		XEResult ReadShaderConstantBuffers(std::ifstream& fileStream, ConstantBufferSignatureList& cbSigList);

		XEResult ReadShaderSimpleBuffers(std::ifstream& fileStream, SimpleBufferSignatureList& simpleBufferSignatureList);

		XEResult ReadShaderStructuredBuffers(std::ifstream& fileStream, StructuredBufferSignatureList& structuredBufferSigList);

		XEResult ReadShaderTextureInputs(std::ifstream& fileStream, TextureInputSignatureList& texInputSigList);

		XEResult ReadShaderTextureArrayInputs(std::ifstream& fileStream, TextureArrayInputSignatureList& texArrayInputSigList);

		XEResult ReadShaderSamplers(std::ifstream& fileStream, SamplerSignatureList& samplerSignatureList);
...
#pragma region Protected Methods
		...
		virtual XEResult LoadShaderWithoutLock(const BYTE* shaderByteCode, uint32_t length) = 0;
...
#pragma region Framework Methods
		...
		XEResult LoadShader(const BYTE* shaderByteCode, uint32_t length);
