...
#pragma region Framework Methods
		...
		/// <returns>XEResult::Ok if successful</returns>
		XEResult AddVariable(ShaderCustomVariable* scv);
		...
		/// <returns>XEResult::Ok if successful</returns>
		XEResult SetValue(const std::wstring& varName, const void* value, uint32_t varSize, bool user = false);
		...
		/// <param name="user">Determine if variable should be user variable only</param>
		/// <returns>XEResult::Ok if successful</returns>
		XEResult GetValue(const std::wstring& varName, void* value, uint32_t varSize, bool user = false);
		...
		/// <returns>XEResult::Ok if successful</returns>
		template<class T>
		XEResult SetValueT(const std::wstring& varName, const T& value, bool user = false)
		{
		...
		/// <returns>XEResult::Ok if successful</returns>
		template<class T>
		XEResult GetValueT(const std::wstring& varName, T& value, bool user = false)
		{
