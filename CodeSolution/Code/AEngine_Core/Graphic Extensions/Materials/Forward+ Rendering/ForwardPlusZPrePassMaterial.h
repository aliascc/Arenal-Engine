...
#pragma region Constructor & Destructor Methods
		...
		ForwardPlusZPrePassMaterial(GraphicDevice* graphicDevice, GameResourceManager* gameResourceManager, const std::wstring& name = AE_FORWARD_PLUS_Z_PRE_PASS_MAT_NAME);
