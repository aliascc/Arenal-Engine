...
AEResult ShaderProperties::CreateFromShaderSignatures(Shader* shader)
{
    ...
    if(ret != AEResult::Ok)
    {
        ...
        AELogHelpers::Log(LogLevel::Error, LogSystem::GraphicsExt, "SHADER_CB_ADD_SIG_LIST_ERR_MSG", __FUNCTION__, shader->GetName(), AE_Base::GetAEResultString(ret));
    ...
    if (ret != AEResult::Ok)
    {
        ...
        AELogHelpers::Log(LogLevel::Error, LogSystem::GraphicsExt, "SHADER_SAM_ADD_SIG_LIST_ERR_MSG", __FUNCTION__, shader->GetName(), AE_Base::GetAEResultString(ret));
    ...
    if(ret != AEResult::Ok)
    {
        ...
        AELogHelpers::Log(LogLevel::Error, LogSystem::GraphicsExt, "SHADER_B_ADD_SIG_LIST_ERR_MSG", __FUNCTION__, shader->GetName(), AE_Base::GetAEResultString(ret));
    ...
    if(ret != AEResult::Ok)
    {
        ...
        AELogHelpers::Log(LogLevel::Error, LogSystem::GraphicsExt, "SHADER_SB_ADD_SIG_LIST_ERR_MSG", __FUNCTION__, shader->GetName(), AE_Base::GetAEResultString(ret));
    ...
    if(ret != AEResult::Ok)
    {
        ...
        AELogHelpers::Log(LogLevel::Error, LogSystem::GraphicsExt, "SHADER_TB_ADD_SIG_LIST_ERR_MSG", __FUNCTION__, shader->GetName(), AE_Base::GetAEResultString(ret));
    ...
    if (ret != AEResult::Ok)
    {
        ...
        AELogHelpers::Log(LogLevel::Error, LogSystem::GraphicsExt, "SHADER_TA_ADD_SIG_LIST_ERR_MSG", __FUNCTION__, shader->GetName(), AE_Base::GetAEResultString(ret));
    ...
    for(const ConstantBufferSignature& constBufferSig : constBufferSigList)
    {
        ...
        for(const ShaderCustomVariable& constSCVar : constBufferSig.m_ShaderCustomVariableList)
        {
            ...
            if(ret != AEResult::Ok)
            {
                ...
                AELogHelpers::Log(LogLevel::Debug, LogSystem::GraphicsExt, "SHADER_CB_SIG_ADD_VAR_DBG_MSG", __FUNCTION__, constSCVar.m_Name, cb->GetName(), AE_Base::GetAEResultString(ret));
        ...
        if(ret != AEResult::Ok)
        {
            AELogHelpers::Log(LogLevel::Debug, LogSystem::GraphicsExt, "SHADER_CB_SIG_INIT_CB_DBG_MSG", __FUNCTION__, cb->GetName(), AE_Base::GetAEResultString(ret));
        ...
        if(ret != AEResult::Ok)
        {
            AELogHelpers::Log(LogLevel::Debug, LogSystem::GraphicsExt, "SHADER_CB_SIG_ADD_CB_DBG_MSG", __FUNCTION__, cb->GetName(), AE_Base::GetAEResultString(ret));
...
AEResult ShaderProperties::AddSamplersFromSigList(const SamplerSignatureList& samplerSigList)
{
    ...
    for (const SamplerSignature& samplerSig : samplerSigList)
    {
        ...
        if (ret != AEResult::Ok)
        {
            AELogHelpers::Log(LogLevel::Debug, LogSystem::GraphicsExt, "SHADER_SAM_SIG_INIT_CB_DBG_MSG", __FUNCTION__, sampler->GetName(), AE_Base::GetAEResultString(ret));
...
AEResult ShaderProperties::AddSimpleBuffersFromSigList(const SimpleBufferSignatureList& simpleBufferSignatureList)
{
    ...
    for(const SimpleBufferSignature& simpleBufferSig : simpleBufferSignatureList)
    {
        ...
        if(ret != AEResult::Ok)
        {
            AELogHelpers::Log(LogLevel::Debug, LogSystem::GraphicsExt, "SHADER_B_SIG_ADD_B_DBG_MSG", __FUNCTION__, simpleBufferSig.m_Name, AE_Base::GetAEResultString(ret));
...
AEResult ShaderProperties::AddStructuredBuffersFromSigList(const StructuredBufferSignatureList& structuredBufferSigList)
{
    ...
    for(const StructuredBufferSignature& structuredBufferSig : structuredBufferSigList)
    {
        ...
        if(ret != AEResult::Ok)
        {
            AELogHelpers::Log(LogLevel::Debug, LogSystem::GraphicsExt, "SHADER_SB_SIG_ADD_SB_DBG_MSG", __FUNCTION__, structuredBufferSig.m_Name, AE_Base::GetAEResultString(ret));
...
AEResult ShaderProperties::AddTextureBindingsFromSigList(const TextureInputSignatureList& textBindingSigList)
{
    ...
    for(const TextureInputSignature& textBindingSig : textBindingSigList)
    {
        ...
        if(ret != AEResult::Ok)
        {
            AELogHelpers::Log(LogLevel::Debug, LogSystem::GraphicsExt, "SHADER_TB_SIG_ADD_TB_DBG_MSG", __FUNCTION__, textBindingSig.m_Name, AE_Base::GetAEResultString(ret));
...
AEResult ShaderProperties::AddTextureArraysFromSigList(const TextureArrayInputSignatureList& textArrayInputSigList)
{
    ...
    for (const TextureArrayInputSignature& textArrayInput : textArrayInputSigList)
    {
        ...
        if (ret != AEResult::Ok)
        {
            AELogHelpers::Log(LogLevel::Debug, LogSystem::GraphicsExt, "SHADER_TA_SIG_ADD_SB_DBG_MSG", __FUNCTION__, textArrayInput.m_Name, AE_Base::GetAEResultString(ret));
        ...
        if(ConstantBufferExists(otherCB->GetName()))
        {
            ...
            for(uint32_t i = 0; i < otherVarCount; i++)
            {
                ...
                if(thisShaderVar->Compare(otherShaderVar))
                {
                    ...
                    if(ret != AEResult::Ok)
                    {
                        AELogHelpers::Log(LogLevel::Warning, LogSystem::GraphicsExt, "SHADER_CB_SET_VALUE_ERR_MSG", __FUNCTION__, thisShaderVar->m_Name, thisCB->GetName(), AE_Base::GetAEResultString(ret));
                    }
                }
            }
        }
        ...
        if(ShaderTextureBindingExists(otherTextBinding->GetName()))
        {
            ...
            if(thisTextBinding->Compare(otherTextBinding))
            {
                ...
                if(otherTextBinding->GetTexture() != nullptr)
                {
                    ...
                    if(ret != AEResult::Ok)
                    {
                        AELogHelpers::Log(LogLevel::Warning, LogSystem::GraphicsExt, "SHADER_TEX_BINDING_SET_ERR_MSG", __FUNCTION__, thisTextBinding->GetName(), AE_Base::GetAEResultString(ret));
