	...
	: QSyntaxHighlighter(parent)
{
	/////////////////////////////////////////////////
	//Set Keywords
	m_KeywordFormat.setForeground(XEQTHelpers::GetQColorFromColor(XEColors::CornflowerBlue));
	...
	m_PreprocessorsFormat.setForeground(XEQTHelpers::GetQColorFromColor(XEColors::IndianRed));
	...
	m_SingleLineCommentFormat.setForeground(XEQTHelpers::GetQColorFromColor(XEColors::ForestGreen));
	...
	m_MultiLineCommentFormat.setForeground(XEQTHelpers::GetQColorFromColor(XEColors::ForestGreen));
	...
	m_QuotationFormat.setForeground(XEQTHelpers::GetQColorFromColor(XEColors::OrangeRed));
	...
	m_FunctionFormat.setForeground(XEQTHelpers::GetQColorFromColor(XEColors::Orange));
