...
void NewProjectDialog::on_m_OkButton_clicked()
{
	...
	if (m_EngineViewer->CreateProjectFolder(projectDir, projectName, createProjectDir) != XEResult::Ok)
	{
		XETODO("Add message");
		return;
	}

	m_ConfigFile = projectDir + L"/" + XE_PROJ_CONFIG_PROJ_FILE;
