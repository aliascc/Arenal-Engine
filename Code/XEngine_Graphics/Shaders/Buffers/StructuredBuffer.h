...
#pragma region Framework Methods
		...
		XEResult InitializeBuffer(uint32_t structSize, uint32_t numElements, GraphicBufferUsage bufferUsage, GraphicBufferAccess bufferAccess);
		...
		XEResult UpdateBuffer(const void* data, uint32_t elementCount, uint32_t startIndex, uint32_t offset, GraphicResourceMap resourceMap);
