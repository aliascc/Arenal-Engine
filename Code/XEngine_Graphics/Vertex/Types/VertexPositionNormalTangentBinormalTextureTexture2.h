...
struct VertexPositionNormalTangentBinormalTextureTexture2
{
	...
	static const VertexLayout* GetVertexLayout(GraphicDevice* graphicDevice)
	{
		...
		XEResult ret = m_VertexLayout->BuildVertexLayout(graphicDevice, DummyVertexPositionNormalTangentBinormalTextureTexture2, sizeof(DummyVertexPositionNormalTangentBinormalTextureTexture2), vertexDesc, 6, L"VertexPositionNormalTangentBinormalTextureTexture2Layout");
