...
struct VertexPositionNormalTangentBinormalTexture
{
	...
	static const VertexLayout* GetVertexLayout(GraphicDevice* graphicDevice)
	{
		...
		XEResult ret = m_VertexLayout->BuildVertexLayout(graphicDevice, DummyVertexPositionNormalTangentBinormalTexture, sizeof(DummyVertexPositionNormalTangentBinormalTexture), vertexDesc, 5, L"VertexPositionNormalTangentBinormalTextureLayout");
