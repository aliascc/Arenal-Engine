...
#pragma region Constructor & Destructor Methods
		...
		Object3D(const std::wstring& name = L"", const glm::vec3& position = XEMathHelpers::Vec3fZero, const glm::vec3& rotation = XEMathHelpers::Vec3fZero, const glm::vec3& scale = XEMathHelpers::Vec3fOne);
...
#pragma region Framework Methods
		...
		XEResult AddObject3DChangeEventCallback(uint64_t id, Object3DChangedEvent changeEventCallback);

		XEResult RemoveObject3DChangeEventCallback(uint64_t id);
