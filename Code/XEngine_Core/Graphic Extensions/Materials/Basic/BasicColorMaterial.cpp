...
XEResult BasicColorMaterial::CreateVertexShader()
{
	XEResult ret = XEResult::Ok;

	/////////////////////////////////////////////////////
	//Get Vertex Shader from Game Resources
	m_VertexShader = (VertexShader*)m_GameResourceManager->AcquireGameResourceByStringID(XE_BASIC_COLOR_MAT_VS_NAME, GameResourceType::VertexShader);

	if(m_VertexShader == nullptr)
	{
		m_VertexShader = new VertexShader(m_GraphicDevice, XE_BASIC_COLOR_MAT_VS_NAME);
		...
		ret = m_GameResourceManager->ManageGameResource(m_VertexShader, XE_BASIC_COLOR_MAT_VS_NAME);
		if(ret != XEResult::Ok)
		{
...
XEResult BasicColorMaterial::CreateVertexShaderConstantBuffer()
{
	XEResult ret = XEResult::Ok;
...
XEResult BasicColorMaterial::CreatePixelShader()
{
	XEResult ret = XEResult::Ok;
	
	/////////////////////////////////////////////////////
	//Get Pixel Shader from Game Resources
	m_PixelShader = (PixelShader*)m_GameResourceManager->AcquireGameResourceByStringID(XE_BASIC_COLOR_MAT_PS_NAME, GameResourceType::PixelShader);
	
	if(m_PixelShader == nullptr)
	{
		m_PixelShader = new PixelShader(m_GraphicDevice, XE_BASIC_COLOR_MAT_PS_NAME);
		...
		ret = m_GameResourceManager->ManageGameResource(m_PixelShader, XE_BASIC_COLOR_MAT_PS_NAME);
		if(ret != XEResult::Ok)
		{
			return XEResult::ResourceManagedFailed;
		}
...
XEResult BasicColorMaterial::LoadContent()
{
