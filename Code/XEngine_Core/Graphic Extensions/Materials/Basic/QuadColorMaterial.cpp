...
XEResult QuadColorMaterial::CreateVertexShader()
{
...
XEResult QuadColorMaterial::CreateVertexShaderConstantBuffer()
{
	XEResult ret = XEResult::Ok;
...
XEResult QuadColorMaterial::CreatePixelShader()
{
	XEResult ret = XEResult::Ok;
	
	/////////////////////////////////////////////////////
	//Get Pixel Shader from Game Resources
	m_PixelShader = (PixelShader*)m_GameResourceManager->AcquireGameResourceByStringID(XE_QUAD_COLOR_MAT_PS_NAME, GameResourceType::PixelShader);
	
	if(m_PixelShader == nullptr)
	{
		m_PixelShader = new PixelShader(m_GraphicDevice, XE_QUAD_COLOR_MAT_PS_NAME);
		...
		ret = m_GameResourceManager->ManageGameResource(m_PixelShader, XE_QUAD_COLOR_MAT_PS_NAME);
		if(ret != XEResult::Ok)
		{
			return XEResult::ResourceManagedFailed;
		}
...
XEResult QuadColorMaterial::CreatePixelShaderConstantBuffer()
{
	XEResult ret = XEResult::Ok;
...
XEResult QuadColorMaterial::LoadContent()
{
