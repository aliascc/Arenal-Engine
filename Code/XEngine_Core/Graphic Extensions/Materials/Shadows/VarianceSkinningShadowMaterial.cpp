...
XEResult VarianceSkinningShadowMaterial::CreateVertexShader()
{
	XEResult ret = XEResult::Ok;

	/////////////////////////////////////////////////////
	//Get Vertex Shader from Game Resources
	m_VertexShader = (VertexShader*)m_GameResourceManager->AcquireGameResourceByStringID(XE_VARIANCE_SKINNING_SHADOW_MAT_VS_NAME, GameResourceType::VertexShader);

	if(m_VertexShader == nullptr)
	{
		m_VertexShader = new VertexShader(m_GraphicDevice, XE_VARIANCE_SKINNING_SHADOW_MAT_VS_NAME);
		...
		ret = m_GameResourceManager->ManageGameResource(m_VertexShader, XE_VARIANCE_SKINNING_SHADOW_MAT_VS_NAME);
		if(ret != XEResult::Ok)
		{
...
XEResult VarianceSkinningShadowMaterial::CreateVertexShaderConstantBuffer()
{
	XEResult ret = XEResult::Ok;
...
XEResult VarianceSkinningShadowMaterial::CreatePixelShader()
{
	XEResult ret = XEResult::Ok;
...
XEResult VarianceSkinningShadowMaterial::LoadContent()
{
