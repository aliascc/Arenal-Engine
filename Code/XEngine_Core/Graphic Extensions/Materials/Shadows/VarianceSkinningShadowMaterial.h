...
#pragma region Constructor & Destructor Methods
		...
		VarianceSkinningShadowMaterial(GraphicDevice* graphicDevice, GameResourceManager* gameResourceManager, const std::wstring& name = XE_VARIANCE_SKINNING_SHADOW_MAT_NAME);
