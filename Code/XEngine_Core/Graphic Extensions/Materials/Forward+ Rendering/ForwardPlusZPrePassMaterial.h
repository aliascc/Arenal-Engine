...
#ifndef _FORWARD_PLUS_Z_PRE_PASS_MATERIAL_H
#define _FORWARD_PLUS_Z_PRE_PASS_MATERIAL_H
...
#pragma region Constructor & Destructor Methods
		...
		ForwardPlusZPrePassMaterial(GraphicDevice* graphicDevice, GameResourceManager* gameResourceManager, const std::wstring& name = XE_FORWARD_PLUS_Z_PRE_PASS_MAT_NAME);
